...
%     S(x(16:18))*InertialTensor*x(16:18)
%     (InertialTensor)*(-k_omega*(x(16:18)-omega_0)-k*x(20)*R_0'*q_1(2:4) + domega_0dt)
%     (InertialTensor)*(-k_omega*(x(16:18)-omega_0)-k*x(20)*R_0'*q_1(2:4) + domega_0dt)
...
%     maxTorqueNorm = maxSingleTorque*(2^0.5)*sin(pi/4)/sin(pi/4 - atan2(torque(1),torque(2)));
